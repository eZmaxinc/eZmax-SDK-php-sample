...
if($objWebhook->getEWebhookEzsignevent() == "FolderCompleted"){
...
F_LOCAL_WriteToLog("ID of folder type : ".$objEzsignfolder->getFkiEzsignfoldertypeID());
F_LOCAL_WriteToLog("Tsa requirement : ".$objEzsignfolder->getFkiEzsigntsarequirementID());
F_LOCAL_WriteToLog("Description of folder : ".$objEzsignfolder->getSEzsignfolderDescription());
F_LOCAL_WriteToLog("Note of folder : ".$objEzsignfolder->getTEzsignfolderNote());
F_LOCAL_WriteToLog("Frequency to send : ".$objEzsignfolder->getEEzsignfolderSendreminderfrequency());
